...
public static Object[][] BunTestData(){
        return new Object[][]{
                {"T",100},// заглавная латиница в одну букву +целое число
                {"verymuchsolongnameforbunhowitwork",100.0f},//длинная латиница без пробелов+дробь с 0
                {"Кириллица",0.1f},// кириллица+дробное число, сотка в дробной части для округления
                {" ТЕСТ",2.99f}, //заглавные с пробелом + округление в дробной части
                {"!@# ",999999999.999f},//символы+большое число
                {null,0},//дефолтные значения
                {"Test Name",-0.01f} //отрицательное число
        };
}
@Test
